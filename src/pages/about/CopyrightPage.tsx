      ...
      <div className="bg-white dark:bg-ink-700 rounded-2xl p-8 shadow-sm">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-ink-800 dark:text-white mb-4">
              原创保护
            </h2>
            <p className="text-ink-500 dark:text-ink-300 leading-relaxed mb-4">
              平行宇宙严格保护原创作者的合法权益。所有在平台发布的内容均受到著作权法保护。
            </p>
            <ul className="list-disc list-inside text-ink-500 dark:text-ink-300 space-y-2">
          ...
          <section className="mb-8">
            ...
            <div className="bg-ink-50 dark:bg-ink-600 rounded-xl p-4">
              <p className="text-ink-500 dark:text-ink-300 text-sm mb-2">
                投诉时请提供以下信息：
              </p>
              <ul className="list-disc list-inside text-ink-500 dark:text-ink-300 text-sm">
                <li>您的身份证明和版权证明</li>
                <li>侵权内容的链接和位置</li>
                <li>侵权事实的详细说明</li>
                <li>您的联系方式</li>
        ...
        <div className="mt-8 p-4 bg-accent-50 dark:bg-accent-500/10 border border-accent-200 dark:border-accent-600 rounded-xl">
