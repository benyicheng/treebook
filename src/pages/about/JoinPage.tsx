    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white dark:bg-ink-700 rounded-2xl p-8 shadow-sm">
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-accent-50 to-accent-100 dark:from-accent-500/10 dark:to-accent-600/10 rounded-xl p-6">
            <h2 className="text-xl font-bold text-ink-800 dark:text-white mb-3">
              全栈开发工程师
            </h2>
            <div className="space-y-2 text-ink-500 dark:text-ink-300 text-sm">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-accent-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6">
            <h2 className="text-xl font-bold text-ink-800 dark:text-white mb-3">
              产品经理
            </h2>
            <div className="space-y-2 text-ink-500 dark:text-ink-300 text-sm">
        ...
        <div className="mt-8 pt-8 border-t border-ink-200 dark:border-ink-600">
          <h3 className="text-lg font-bold text-ink-800 dark:text-white mb-4">
            如何申请
          </h3>
          <p className="text-ink-500 dark:text-ink-300 mb-4">
            请将您的简历发送至：jobs@paralleluniverse.com
          </p>
          <p className="text-ink-500 dark:text-ink-300 mb-6">
            邮件标题格式：应聘职位 - 姓名
          </p>
          <Link
            to="/"
            className="inline-flex items-center px-6 py-3 bg-ink-100 dark:bg-ink-600 hover:bg-ink-200 dark:hover:bg-ink-500 text-ink-800 dark:text-white font-bold rounded-xl transition-colors"
          >
            返回首页
          </Link>
        </div>
