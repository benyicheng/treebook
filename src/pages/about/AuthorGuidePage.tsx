      ...
      <div className="bg-white dark:bg-ink-700 rounded-2xl p-8 shadow-sm">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-ink-800 dark:text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-accent-400 text-white rounded-lg flex items-center justify-center text-sm mr-3">1</span>
              创建主线故事
            </h2>
            <div className="ml-11">
              <p className="text-ink-500 dark:text-ink-300 mb-3">
          ...
          <section>
            <h2 className="text-2xl font-bold text-ink-800 dark:text-white mb-4 flex items-center">
              <span className="w-8 h-8 bg-ink-500 text-white rounded-lg flex items-center justify-center text-sm mr-3">5</span>
              创作建议
            </h2>
            <div className="ml-11">
              <ul className="list-disc list-inside text-ink-500 dark:text-ink-300 space-y-2">
