  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      ...
      <div className="flex items-center justify-between">
        <button onClick={() => navigate(-1)} className="flex items-center gap-2 px-4 py-2 bg-ink-50 dark:bg-ink-700 rounded-xl text-sm font-bold text-ink-500 hover:bg-ink-100 dark:hover:bg-ink-600 transition-colors">
          <ArrowLeft size={16} />
          返回
        </button>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white dark:bg-ink-700 rounded-3xl border border-ink-100 dark:border-ink-600 p-8 space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-bold text-ink-500">标题 *</label>
            <input
              type="text"
              required
        ...
        <div className="bg-white dark:bg-ink-700 rounded-3xl border border-ink-100 dark:border-ink-600 p-8 space-y-4">
          <label className="text-sm font-bold text-ink-500">内容类型</label>
        ...
        <div className="bg-white dark:bg-ink-700 rounded-3xl border border-ink-100 dark:border-ink-600 p-8 space-y-4">
          <div className="flex items-center justify-between">
            <label className="text-sm font-bold text-ink-500">内容（支持 Markdown）</label>
        ...
        {/* Status */}
        <div className="bg-white dark:bg-ink-700 rounded-3xl border border-ink-100 dark:border-ink-600 p-8 space-y-4">
          <label className="text-sm font-bold text-ink-500">状态</label>
