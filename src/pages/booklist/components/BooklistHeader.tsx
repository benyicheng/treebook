          ...
          <div className="flex items-center gap-6 pt-4 text-gray-400">
            ...
            {completedCount > 0 && (
              <>
                <div className="h-8 w-[1px] bg-gray-100 dark:bg-gray-700"></div>
                <div className="text-left">
                  <p className="text-xs font-black uppercase tracking-widest leading-none mb-1 text-emerald-600">阅读进度</p>
                  <p className="text-sm font-bold text-emerald-600">{completedCount}/{totalItems} 站已完成</p>
                </div>
              </>
            )}
          </div>
