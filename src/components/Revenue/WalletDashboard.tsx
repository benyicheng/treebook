  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-indigo-600 to-violet-700 p-8 lg:p-6 rounded-3xl text-white shadow-xl shadow-indigo-200 relative overflow-hidden group col-span-1 md:col-span-2 lg:col-span-1">
          ...
          <div className="mt-6 flex gap-2">
            ...
            <button className="flex-1 bg-white text-indigo-700 py-2 rounded-xl text-xs font-bold transition-all shadow-lg">
              充值
            </button>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <div className="flex justify-between items-start">
            ...
            <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-lg">创作</span>
          </div>
          <div className="mt-4">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <div className="flex justify-between items-start">
            ...
            <span className="text-xs font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-lg">策展</span>
          </div>
          <div className="mt-4">
